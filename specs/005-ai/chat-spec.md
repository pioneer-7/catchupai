...
> **SSOT 문서** — 교강사용 AI 상담, 시스템 프롬프트, 가드레일, 스트리밍, 세션, API, UI

---

## 1. 개요

**교강사/운영자**를 위한 AI 어시스턴트. 특정 학생의 위험 요인과 데이터를 기반으로 **개입 전략, 교수법 조언, 메시지 초안 작성** 등을 대화형으로 지원한다. 학생이 직접 사용하는 것이 아니라, 교강사가 학생 상세 페이지에서 AI에게 상담하는 구조.
