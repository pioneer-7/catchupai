...
export const studentService = {
  async getStudentList(filters?: {
    ...
    try {
      ...
      logDemoSampleFallback('studentService.getStudentList', error);
      return getDemoStudentList(filters);
    }
  },
  ...
  async getStudentDetail(studentId: string): Promise<StudentDetailData | null> {
    try {
      ...
      if (!student) return getDemoStudentDetail(studentId);
      ...
      logDemoSampleFallback('studentService.getStudentDetail', error);
      return getDemoStudentDetail(studentId);
    }
  },
};
